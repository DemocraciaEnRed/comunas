...
function FilterView() {
  ...
  this.onsearchchangeDebounced = debounce(this.onsearchchange, 100, false);
  ...
  this.searchBox = this.find('#search-box input');
}
...
FilterView.prototype.switchOn = function() {
  ...
  this.bind('input', '#search-box input', 'onsearchchangeDebounced');
...
FilterView.prototype.onsearchchange = function(ev) {
  filter.set('search', this.searchBox.val());
};
